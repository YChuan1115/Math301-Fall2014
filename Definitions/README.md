...
+ n-ary relation  
+ n-ary function (f: X<sup>n</sup> --> Y)  
+ n-ary operation (f: X<sup>n</sup> --> X)  
...
+ largest element (of a poset; need not exist)  
+ smallest element (of a poset; need not exist)  
...
+ [index](http://en.wikipedia.org/wiki/Index_of_a_subgroup) of a subgroup  
+ [conjugate](http://en.wikipedia.org/wiki/Conjugacy_class#Definition) elements of a group
...
+ [kernel of a homomorphism](http://en.wikipedia.org/wiki/Kernel_(algebra)#Universal_algebra) (a [congruence relation](http://en.wikipedia.org/wiki/Congruence_relation))  
